...
LRUCache.prototype.get = function (key) {
  const cacheTimeItem = new LRUCacheItem(null, key);
  this.timeStorage.unshift(cacheTimeItem);
  if (this.timeStorage.head.val.key === this.timeStorage.tail.val.key) {
    this.timeStorage.pop();
  }
...
LRUCache.prototype.set = function (key, val) {
  const cacheTimeItem = new LRUCacheItem(null, key);
  this.timeStorage.unshift(cacheTimeItem);
  if (this.currentSize === this.maxSize && this.timeStorage.tail !== null) {
    const keyToDelete = this.timeStorage.tail.val.key
